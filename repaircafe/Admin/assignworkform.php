  ...
  <form action="" method="POST">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <select class="form-control" id="assigntech" name="assigntech" placeholder="Enter Technician" >
        <option value="Karnataka">Karan</option>
        <option value="Goa">Guru</option>
        <option value="Jeevan">Jeevan</option>
        <option value="Kerala">Ramnath</option>
</select>
      </div>
      <div class="form-group col-md-6">

...
<head>
  ...
  <title>Repair Cafe | Admin Login</title>
</head>
...
<body>
  ...
  <p class="text-center" style="font-size: 20px; font-style: italic;"> <span>Admin Login(Restricted to customer)</span>
  </p>
  <div class="container-fluid mb-5">
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        <form action="" class="p-4" method="POST" style="border: 2px solid black;">
          <div class="form-group">
            <i class="fas fa-user"></i><label for="email" class="pl-2 font-weight-bold">Email</label><input type="email"
              class="form-control" placeholder="Enter Admin Email" name="aEmail">
          </div>
          <div class="form-group">
            <i class="fas fa-key"></i><label for="pass" class="pl-2 font-weight-bold">Password</label><input type="password"
              class="form-control" placeholder="Enter Admin Password" name="aPassword">
          </div>
          <button type="submit" class="btn btn-outline-dark mt-3 btn-block shadow-sm font-weight-bold">Login</button>
          <?php if(isset($msg)) {echo $msg; } ?>
          <div class="text-center"><a class="btn btn-dark mt-3 shadow-sm font-weight-bold" href="../index.php">Back to Home</a></div>
        </form>

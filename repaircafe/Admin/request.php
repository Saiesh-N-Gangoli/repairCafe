...
<div class="col-sm-4 mb-5">
 ...
 if($result->num_rows > 0){
  ...
  echo '<div class="alert alert-success mt-5 col-sm-6" role="alert">
  <h4 class="alert-heading" style="font-size: 26px;font-weight: bold;text-align: center;">Hurray!!</h4>
  <p style="text-align: center;font-style: italic;">No More Pending Requests</p>
  <hr>
  <h5 class="mb-0" style="text-align: center;font-size: 18px; font-weight: bold;">No Requests Available</h5>
</div>';
 }

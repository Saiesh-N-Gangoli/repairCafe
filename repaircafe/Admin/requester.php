...
<div class="col-sm-9 col-md-10 mt-5 text-center">
  <!--Table-->
  <p class=" bg-dark text-white p-2">Requesters Record</p>
  <?php
 ...
 echo '<table class="table">
  ...
  while($row = $result->fetch_assoc()){
   echo '<tr>';
    ...
    echo '<td><form action="editreq.php" method="POST" class="d-inline"> <input type="hidden" name="id" value='. $row["r_login_id"] .'><button type="submit" class="btn btn-dark mr-3" name="view" value="View">Edit</button></form>  
...
<div><a class="btn btn-dark box" href="insertreq.php">Add Record</a>
</div>
</div>
<?php

...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php" style="font-size: 24px;">Repair Cafe</a>
 </nav>
 ...
 <div class="container-fluid mb-5 " style="margin-top:40px;">
  <div class="row">
   <nav class="col-sm-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky" style="border: 2px solid black;">
     <ul class="nav flex-column">
      <li class="nav-item">
          <h2 style="text-align: center;font-size: 21px;font-weight: bold;">My Profile</h2>
       <a class="nav-link <?php if(PAGE == 'RequesterProfile') { echo 'active'; } ?>" href="RequesterProfile.php">
        <i class="fas fa-user"></i>
        My Info <span class="sr-only">(current)</span>
       </a>
      </li>
      <li class="nav-item">

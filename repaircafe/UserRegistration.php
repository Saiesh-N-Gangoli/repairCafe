...
?>
<div class="container pt-5" id="registration" style="position: relative;bottom: 121px;/*! top: -52px;">
      ...
      <form action="" class="p-4" method="POST" style="border: 2px solid black;">
        <div class="form-group">
          <i class="fas fa-user"></i><label for="name" class="pl-2 font-weight-bold">Name</label><input type="text"
            class="form-control" placeholder="Enter Your Name" name="rName">
        </div>
        <div class="form-group">
        <i class="fas fa-envelope-open-text"></i><label for="email" class="pl-2 font-weight-bold">Email</label><input type="email"
            class="form-control" placeholder="Enter Your Email" name="rEmail">
